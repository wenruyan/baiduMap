        ...
        <div class="readcontent">
            ...
            <div class="readnext">
                <Row type="flex" style="height:100%">
                    ...
                    <Col span="8" order="2" style="position:relative">
                        <el-progress class="progress1" color = "#64A4ED" :stroke-width="30" :percentage="this.Battery_Stack_SOC_1"></el-progress>
            ...
            <div class="readnext">
                <Row type="flex" style="height:100%">
                    ...
                    <Col span="8" order="2" style="position:relative">
                        <el-progress class="progress2" color = "#FCA636"  :stroke-width="30" :percentage="this.Battery_Stack_SOC_2"></el-progress>
            ...
            <div class="readnext">
                <Row type="flex" style="height:100%">
                    ...
                    <Col span="8" order="2" style="position:relative">
                        <el-progress class="progress3" color = "#A4C86E" :stroke-width="30" :percentage="this.Battery_Stack_SOC_3"></el-progress>
            ...
            <div class="readnext">
                <Row type="flex" style="height:100%">
                    ...
                    <Col span="8" order="2" style="position:relative">
                        <el-progress class="progress4" color="#FFC3BB"  :stroke-width="30" :percentage="this.Battery_Stack_SOC_4"></el-progress>
...
export default {
    ...
    methods:{
        ...
        deviceSatus(){
            ...
            that.$store.state.readSystemStatus = new WebSocket("wss://" + 'hehang.xyz:8082' + "/api/ws/plugins/telemetry?token=" + 
        ...
        tableLeft(){
            ...
            .then((response) => {
                ...
                that.$store.state.readLeftTable = new WebSocket("wss://" + 'hehang.xyz:8082' + 
        ...
        getInfo(){
            ...
            that.$store.state.readInfo = new WebSocket("wss://" + 'hehang.xyz:8082' + "/api/ws/plugins/telemetry?token=" + 
                'eyJhbGciOiJIUzUxMiJ9..PyJMAdnHceoCGP35zssrghIHw_A2EyynthLmld2JBQkDE3KrTfxg-xoZeYWJEofNqg-qzpWfoXmMH1xAs-3VwA');
            ...
            if (data) {
                ...
                this.Battery_Stack_SOC_1 = Number(data.Battery_Stack_SOC_1[0][1]).toFixed(3);
                ...
                // }, 1000);
                this.Battery_Stack_SOC_2 = Number(data.Battery_Stack_SOC_2[0][1]).toFixed(3);
                ...
                // }, 1000);
                this.Battery_Stack_SOC_3 = Number(data.Battery_Stack_SOC_3[0][1]).toFixed(3);
                ...
                // }, 1000);
                this.Battery_Stack_SOC_4 = Number(data.Battery_Stack_SOC_4[0][1]).toFixed(3);
        ...
        drawlineone (){
            ...
            that.$store.state.echartsOne  = new WebSocket("wss://" + 'hehang.xyz:8082' + "/api/ws/plugins/telemetry?token=" + 
                'eyJhbGciOiJIUzUxMiJ9..PyJMAdnHceoCGP35zssrghIHw_A2EyynthLmld2JBQkDE3KrTfxg-xoZeYWJEofNqg-qzpWfoXmMH1xAs-3VwA');
                    ...
                    // 长度为一，表示为新数据
                        if (data.System_SOC) {
                            ...
                            dataSOC.push({
                                ...
                                value: [data.System_SOC[0][0], data.System_SOC[0][1]]
                            });
        ...
        drawlinethree(){
            ...
            that.$store.state.echartsTwo = new WebSocket("wss://" + 'hehang.xyz:8082' + "/api/ws/plugins/telemetry?token=" + 
                'eyJhbGciOiJIUzUxMiJ9..PyJMAdnHceoCGP35zssrghIHw_A2EyynthLmld2JBQkDE3KrTfxg-xoZeYWJEofNqg-qzpWfoXmMH1xAs-3VwA');
        ...
        drawlinefour(){
            ...
            that.$store.state.echartsThree = new WebSocket("wss://" + 'hehang.xyz:8082' + "/api/ws/plugins/telemetry?token=" + 
                'eyJhbGciOiJIUzUxMiJ9..PyJMAdnHceoCGP35zssrghIHw_A2EyynthLmld2JBQkDE3KrTfxg-xoZeYWJEofNqg-qzpWfoXmMH1xAs-3VwA');
