  ...
  <div class="historyAlarm" style="height:100%" ref="maxBox">
    <div class="alarmtop clearfix" ref="alarmTop">
      ...
      <div class="select">
        ...
        <!-- <el-date-picker :editable="false" :picker-options="startOptions" @change=selectStartTime v-model="startTime" type="datetime" placeholder="datetime" format="yyyy-MM-dd HH:mm"></el-date-picker> -->
      ...
      <div class="select">
        <span>End Time:</span>
        <!-- <el-date-picker :editable="false" :picker-options="endOptions" @change=selectEndTime v-model="endTime" type="datetime" placeholder="datetime" format="yyyy-MM-dd HH:mm"></el-date-picker> -->
