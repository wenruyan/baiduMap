  ...
  <div class="historydata" style="height:100%" ref="maxBox">
    <div class="historytop clearfix" ref="historytop">
      ...
      <div class="select">
        ...
        <el-date-picker :editable="false" :picker-options="startOptions" @change=selectStartTime v-model="startTime" type="datetime" placeholder="start time" format="yyyy-MM-dd HH:mm"></el-date-picker>
      ...
      <div class="select">
        <span>End Time:</span>
        <el-date-picker :editable="false" :picker-options="endOptions" @change=selectEndTime v-model="endTime" type="datetime" placeholder="end time" format="yyyy-MM-dd HH:mm"></el-date-picker>
        <!-- <el-date-picker :editable="false" :picker-options="endOptions" :value="endTime" @change=selectEndTime type="datetime" format="yyyy-MM-dd HH:mm" placeholder="end time" :style="{width:$store.state.selectWidth,marginRight: '30px'}"></el-date-picker> -->
      </div>
      <div class="select">
        <span>Interval:</span>
      ...
      <div class="select">
        ...
        <!-- <el-date-picker v-model="value10" type="datetime" placeholder="选择日期" format="yyyy-MM-dd HH:mm"></el-date-picker> -->
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    selectEndTime(value) {
      ...
      value = this.FormatAllDate(value)
