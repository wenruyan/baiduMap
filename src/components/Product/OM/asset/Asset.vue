  ...
  data(){
      ...
      methods: {
        ...
        setGooleMapTable(data){
          ...
          // var markers = [
          //     {
          //       content:"No. 99, Baoshan District Road, Shanghai",
          //       title:"College of computer engineering and science, Shanghai University",
          //       imageOffset: {width:0,height:3},
          //       position:{lat:21.323755,lng:121.406422}
          //     },
          //   ];
